...
<div class="c-container-vertical--small">
    <div class="c-content">
        ...
        <p>The transition can be seen here <a href="https://example.routify.dev/example/transitions/tabs/feed/" target="_blank">Example</a> (<a href="https://github.com/sveltech/routify/blob/master/runtime/decorators/TabsTransition.svelte"> source </a>).</p>
        <ul>
